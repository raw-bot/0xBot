...
class Alert(Base):
    ...
    type: Mapped[str] = mapped_column(
        SQLEnum(AlertType, name="alert_type_enum", create_constraint=True), nullable=False
    )
    severity: Mapped[str] = mapped_column(
        SQLEnum(AlertSeverity, name="alert_severity_enum", create_constraint=True), nullable=False
    )
