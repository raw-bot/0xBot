...
class PositionMonitor:
    ...
    async def monitor_positions(self, positions: list) -> None:
    ...
    async def close_all_positions(self, positions: list, current_price: Decimal) -> None:
    ...
    async def update_position_status(self, position_id: str, status: PositionStatus) -> None:
